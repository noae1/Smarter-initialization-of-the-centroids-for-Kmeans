...
integrated with the K-means algorithm that is ported to a C extension using the C API, ensuring a smarter initialization of the centroids and improves the quality of the clustering.
